...
function bones_theme_support() {
	...
	register_nav_menus(
		...
		array(
			'left-main-nav' => __( 'The Main Menu (left half)', 'bonestheme' ),   // left half of main nav in header
			'right-main-nav' => __( 'The Main Menu (right half)', 'bonestheme' )  // right half of main nav in header
		)
	);
