		<footer class="footer" role="contentinfo">
			<div id="wisdom">
				<h3>Pearls of Wisdom &#8211; <a href="https://twitter.com/DunhamScott">@dunhamscott</a></h3>
				<p id="tweet"></p>
				<p id="posted"></p>
			</div>
			<div id="people">
			...
			<div id="friends">
				...
				<ul>
					...
					<li><a href="http://www.linkedin.com/in/sdunham" class="linkedin">Linkedin</a></li>
				</ul>
			</div>
			<hr>
			<p id="tagline">
				<span id="copy">Copyright &copy; <?php echo date('Y'); ?> <?php bloginfo('name'); ?></span>
				<span id="shoutout">Made from sunshine, lollipops, rainbows, and <a href="http://wordpress.org">Wordpress</a>... In that order.</span>
			</p>
		</footer> <!-- end footer -->
